    ...
    <div className='bg-primary min-h-screen flex flex-col justify-center gap-16'>
      <div className="flex items-center ">
        <div className='flex-1 md:p-8 p-4'>
          <h1 className="font-heading text-6xl text-white">Fewer mistakes. Faster service. Happier customers.</h1>
          <p className='text-white/80 mt-6 text-lg max-w-xl'>
            SwipeEat brings waiters, kitchen staff, and management together in one real-time system to streamline ordering, improve kitchen flow, and keep service running smoothly.
          </p>
      ...
      <div className='flex justify-between md:p-8 p-4'>
        <h1 className='font-mono uppercase'>Trusted by over 1,000 restaurants worldwide</h1>
        <div>
          {/* <Image src="/logos.png" alt="Logos" width={400} height={100} /> */}
        </div>
      </div>
    </div>
  )
